...
- [ ] 【锁管理】加锁后必须释放锁，并确认锁变量一致；
- [ ] 【fd管理】fd申请后必须关闭，代开与关闭成对使用；
- [ ] 【内存管理】内存申请前必须对内存大小进行合法性校验；
- [ ] 【内存管理】内存申请后必须释放，申请与释放成对使用；
...
- [ ] 【常见问题】CHECK_AND_RETURN、CHECK_AND_RETURN_RET_LOG_INNER等宏确认无资源漏释放；
