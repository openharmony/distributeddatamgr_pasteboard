...
public:
    ...
    {
        if (online_ == nullptr || deviceInfo.DmAuthForm != IDENTICAL_ACCOUNT) {
            return;
        }
        online_(deviceInfo);
    ...
    {
        if (offline_ == nullptr || deviceInfo.DmAuthForm != IDENTICAL_ACCOUNT)  {
            return;
        }
        offline_(deviceInfo);
    ...
    {
        if (onReady_ == nullptr || deviceInfo.DmAuthForm != IDENTICAL_ACCOUNT) {
            return;
        }
        onReady_(deviceInfo);
    }
