...
{
    auto unifiedRecord = std::make_shared<UDMF::PlainText>(*(record->GetPlainText()), record->GetTextContent());
...
{
    return std::make_shared<UDMF::UnifiedRecord>(UDMF::OPENHARMONY_WANT, record->GetWant());
}
