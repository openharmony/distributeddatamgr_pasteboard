...
class API_EXPORT EntityRecognitionObserver : public EntityRecognitionObserverStub {
public:
    EntityRecognitionObserver();
    ~EntityRecognitionObserver();
    virtual void OnRecognitionEvent(EntityType entityType, std::string &entity) override;
};
} // namespace MiscServices
} // namespace OHOS
