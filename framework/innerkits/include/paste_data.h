...
public:
    ...
    std::vector<std::string> GetReportMimeTypes() const;
    uint8_t GenerateDataType() const;
    DataDescription GetReportDescription() const;
    std::shared_ptr<std::string> GetPrimaryHtml() const;
    std::shared_ptr<OHOS::Media::PixelMap> GetPrimaryPixelMap() const;
    std::shared_ptr<std::string> GetPrimaryText() const;
    std::shared_ptr<OHOS::Uri> GetPrimaryUri() const;
    std::shared_ptr<std::string> GetPrimaryMimeType() const;
    std::shared_ptr<OHOS::AAFwk::Want> GetPrimaryWant() const;
    ...
    int32_t GetOriginTokenId() const;
