...
// HOST-TEST SHIM for pasteboard_hilog.h (clip_plugin suite).
// Drops device logging; preserves control-flow of the check macros used by
// clip_plugin.cpp (PASTEBOARD_CHECK_AND_RETURN_RET_LOGE returns `ret` on false).

#ifndef PASTEBOARD_HOSTTEST_SHIM_CLIP_HILOG_H
#define PASTEBOARD_HOSTTEST_SHIM_CLIP_HILOG_H
...
#endif // PASTEBOARD_HOSTTEST_SHIM_CLIP_HILOG_H
