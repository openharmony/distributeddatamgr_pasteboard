...
// HOST-TEST SHIM for pasteboard_hilog.h (progress_signal suite).
// Drops device logging; no check macros are used by this .cpp.

#ifndef PASTEBOARD_HOSTTEST_SHIM_PROGRESS_HILOG_H
#define PASTEBOARD_HOSTTEST_SHIM_PROGRESS_HILOG_H

namespace OHOS {
namespace MiscServices {
enum PasteboardModule {
    PASTEBOARD_MODULE_CLIENT = 0,
...
#endif // PASTEBOARD_HOSTTEST_SHIM_PROGRESS_HILOG_H
