...
void HiViewAdapter::ReportPasteboardFault(int dfxCode, const PasteboardFaultMsg &msg)
{
    HiSysEventParam params[] = {
        ...
        },
        {
            .name = "ERROR_TYPE",
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)msg.errorCode.c_str() },
            .arraySize = 0,
        },
    };
    size_t len = sizeof(params) / sizeof(params[0]);
    int ret = OH_HiSysEvent_Write(PASTEBOARD_DOMAIN, CoverEventID(dfxCode).c_str(), HISYSEVENT_FAULT, params, len);
    if (ret != 0) {
        PASTEBOARD_HILOGD(
            ...
            HiSysEventParam params[] = {
                {
                    ...
                    .t = HISYSEVENT_STRING,
                    .v = { .s = (char *)pasteboardState.c_str() },
                    .arraySize = 0,
                },
                {
                    .name = { "NET_TYPE" },
                    .t = HISYSEVENT_STRING,
                    .v = { .s = (char *)netType.c_str() },
                    .arraySize = 0,
                },
                { .name = { "DATA_LEVEL" },
                    .t = HISYSEVENT_STRING,
                    .v = { .s = (char *)GetDataLevel(i) },
                    .arraySize = 0 },
                {
                    .name = { "CONSUMING_DATA" },
                    .t = HISYSEVENT_STRING,
                    .v = { .s = (char *)buffMsg.c_str() },
                    .arraySize = 0,
                },
            };
            size_t len = sizeof(params) / sizeof(params[0]);
...
void HiViewAdapter::ReportBehaviour(std::map<std::string, int> &behaviour, const char *pasteboardState)
{
    ...
    HiSysEventParam params[] = {
        ...
        { .name = { "TOP_TOW_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[1].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_THREE_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[2].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_FOUR_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[3].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_FIVE_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[4].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_SIX_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[5].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_SEVEN_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[6].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_EIGHT_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[7].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_NINE_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[8].c_str() },
            .arraySize = 0 },
        { .name = { "TOP_TEN_APP" },
            .t = HISYSEVENT_STRING,
            .v = { .s = (char *)appPackName[9].c_str() },
            .arraySize = 0 },
    };
        ...
        HiSysEventParam params[] = {
            {
                .name = { "PASTEBOARD_STATE" },
                .t = HISYSEVENT_STRING,
                .v = { .s = (char *)stateStr.c_str() },
                .arraySize = 0,
            },
            {
                .name = { "BOOTTIME" },
                .t = HISYSEVENT_INT64,
                .v = { .i64 = TimeServiceClient::GetInstance()->GetBootTimeMs() },
                .arraySize = 0,
            },
            {
                .name = { "WALLTIME" },
                .t = HISYSEVENT_INT64,
                .v = { .i64 = TimeServiceClient::GetInstance()->GetWallTimeMs() },
                .arraySize = 0,
            },
            ...
            { .name = { "OPERATE_APP" },
                .t = HISYSEVENT_STRING,
                .v = { .s = (char *)bundleName.c_str() },
                .arraySize = 0 },
            {
                .name = { "PRI_MIME_TYPE" },
                .t = HISYSEVENT_STRING,
                .v = { .s = (char *)primaryMimeType.c_str() },
                .arraySize = 0,
            },
            {
                .name = { "ISLOCALPASTE" },
            ...
            },
            {
                .name = { "SHAREOPTION" },
                .t = HISYSEVENT_STRING,
                .v = { .s = (char *)shareOption.c_str() },
                .arraySize = 0,
            },
        };
        size_t len = sizeof(params) / sizeof(params[0]);
        int ret = OH_HiSysEvent_Write(
            PASTEBOARD_DOMAIN, CoverEventID(DfxCodeConstant::USE_BEHAVIOUR).c_str(), HISYSEVENT_BEHAVIOR, params, len);
        if (ret != HiviewDFX::SUCCESS) {
            PASTEBOARD_HILOGD(PASTEBOARD_MODULE_SERVICE, "hisysevent write failed! ret %{public}d.", ret);
        }
