...
#ifndef OHOS_PASTEBOARD_DELAY_GETTER_CLIENT_H
#define OHOS_PASTEBOARD_DELAY_GETTER_CLIENT_H

#include "pasteboard_delay_getter_stub.h"

namespace OHOS {
namespace MiscServices {
class PasteboardDelayGetterClient : public PasteboardDelayGetterStub {
public:
...
private:
    std::shared_ptr<PasteboardDelayGetter> delayGetter_;
};
} // namespace MiscServices
} // namespace OHOS
#endif // OHOS_PASTEBOARD_DELAY_GETTER_CLIENT_H