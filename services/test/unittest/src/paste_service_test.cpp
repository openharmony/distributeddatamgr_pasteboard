...
* @tc.desc: RemovePasteboardChangedObserver.
* @tc.type: FUNC
* @tc.require: AROOOH5R5G
*/
...
* @tc.author: chenyu
*/
HWTEST_F(PasteboardServiceTest, PasteDataMarshallingUnMarshalling001, TestSize.Level0)
{
    std::string htmlText = "<div class='disabled item tip user-programs'>";
    auto pasteData = PasteboardClient::GetInstance()->CreateHtmlData(htmlText);
    Parcel parcel;
...
* @tc.author: chenyu
*/
HWTEST_F(PasteboardServiceTest, PasteDataRecordMarshallingUnMarshalling001, TestSize.Level0)
{
    std::shared_ptr<OHOS::AAFwk::Want> want = std::make_shared<OHOS::AAFwk::Want>();
    std::string key = "id";
    int32_t id = 456;
...
* @tc.author: chenyu
*/
HWTEST_F(PasteboardServiceTest, ConvertToText001, TestSize.Level0)
{
    std::string htmlText = "<div class='disabled item tip user-programs'>";
    auto record = PasteboardClient::GetInstance()->CreateHtmlTextRecord(htmlText);
    ASSERT_TRUE(record != nullptr);
